  ...
  return (
    <div className="w-full min-h-screen bg-[#1b1a1a]">
      <nav className="fixed w-full top-0 z-1000 bg-[#333] flex flex-col lg:flex-row h-fit pb-5 lg:h-20vh">
        ...
        <ul className="ml-4 lg:ml-[400px] md:ml-[200px] tezt-md md:text-lg inline-flex">
          <li className="mr-4 lg:mr-5 mt-10 text-white"><a href="#home">Home</a></li>
          <li className="mr-4 lg:mr-5 mt-10 text-white"><a href="#skills">Skills</a></li>
          <li className="mr-4 lg:mr-5 mt-10 text-white"><a href="#projects">Projects</a></li>
